from model.DirectedGraph import DirectedGraph
...
di_google_graph = DirectedGraph(n, e)
...
print('доля вершин в максимальной по мощности компоненте слабой связности: ',
      google_graph.nodes_in_weakly_comp_with_max_power())
print('доля вершин в максимальной по мощности компоненте сильной связности: ',
      di_google_graph.nodes_in_strongly_comp_with_max_power())
...
print('доля вершин в максимальной по мощности компоненте слабой связности: ',
      vk_graph.nodes_in_weakly_comp_with_max_power())
